...
def wav_to_stft(
    ...
    th_audio.save("atest.wav", raw_audio, sample_rate = 44100)
    ...
    tmp_audio = th_audio_f.inverse_spectrogram(complex_values,pad=0, window=hann_window,
        n_fft=nperseg, hop_length=stride, win_length=nperseg,normalized=True, length = 441000)
    th_audio.save("atest.wav", th.stack((tmp_audio, tmp_audio)), sample_rate = 44100)
